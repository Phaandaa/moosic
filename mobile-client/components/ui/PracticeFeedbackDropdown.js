...
const data = [
  { label: "A - 10 points", value: "10" },
  { label: "B - 8 points", value: "8" },
  { label: "C - 6 points", value: "6" },
  { label: "D - 4 points", value: "4" },
  { label: "F - 0 points", value: "0" },
];

const PracticeFeedbackDropdown = (props) => {
...
export default PracticeFeedbackDropdown;
